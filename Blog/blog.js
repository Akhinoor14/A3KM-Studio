...
(function(){
  ...
  const POSTS_INDEX = '../Blog Contents/posts.json';
  const POSTS_DIR = '../Blog Contents/posts/';
  const SITE_TITLE = 'Md Akhinoor Islam - Portfolio Blog';
  const SITE_URL = location.origin;
  const DEFAULT_COVER = '../Blog Contents/Images/default-cover.svg';
  const WELCOME_COVER = '../Blog Contents/Images/welcome-cover.svg';
