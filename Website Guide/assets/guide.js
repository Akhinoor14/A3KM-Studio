...
function initMobileNav() {
  ...
  const backHref    = isSubfolder ? guideRoot + 'index.html' : siteRoot + 'Home/index.html';

  /* ── Inject m-nav + drawer (skip if page already has one) ── */
  if (!document.querySelector('.m-nav')) {
    document.body.insertAdjacentHTML('afterbegin',
      `<nav class="m-nav" id="mobileNav">` +
        `<a href="${backHref}" class="m-nav-back" title="Back"><i class="fas fa-arrow-left"></i></a>` +
        `<a href="${siteRoot}Home/index.html" class="m-nav-logo">` +
        ...
        `<div class="m-nav-menu">` +
          `<button class="m-nav-btn" id="mNavMenuBtn" title="Navigation" aria-label="Open navigation menu" aria-expanded="false">` +
      ...
      `<div class="m-drawer" id="mDrawer">` +
        `<div class="m-drawer-links">` +
          `<a href="${guideRoot}index.html" class="m-drawer-link"><i class="fas fa-book-open"></i><span>Guide Home</span></a>` +
          `<a href="${guideRoot}features.html" class="m-drawer-link"><i class="fas fa-search"></i><span>Features</span></a>` +
          `<a href="${guideRoot}mobile-guide/index.html" class="m-drawer-link"><i class="fas fa-mobile-alt"></i><span>Mobile Guide</span></a>` +
          `<a href="${guideRoot}desktop/index.html" class="m-drawer-link"><i class="fas fa-desktop"></i><span>Desktop Guide</span></a>` +
          `<a href="${siteRoot}Home/index.html" class="m-drawer-link"><i class="fas fa-home"></i><span>A3KM Studio</span></a>` +
          `<a href="${siteRoot}Contact/contact.html" class="m-drawer-link"><i class="fas fa-envelope"></i><span>Contact</span></a>` +
        `</div>` +
      `</div>`
    );
