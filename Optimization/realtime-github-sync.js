    ...
    async performSync() {
        ...
        try {
            ...
            if (lastPushTime > lastSyncTime) {
                ...
                // Show notification (desktop fallback)
                if (typeof showNotification === 'function') {
                    showNotification('🆕 Website updated with latest GitHub changes!', 'success');
                }
                
                // Show mobile notification
                if (typeof showMobileSyncNotification === 'function') {
                    showMobileSyncNotification('🆕 New projects detected! Page will refresh...', 'success');
