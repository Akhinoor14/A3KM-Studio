/**
 * YouTube Data API v3 Configuration (Mobile Version)
 * 
...
const YOUTUBE_CONFIG = {
    ...
    PARTS: ['contentDetails', 'statistics', 'snippet']
};
...
function validateYouTubeConfig() {
    if (!YOUTUBE_CONFIG.API_KEY || 
        ...
        console.info('2. Edit: mobile/content-studio/video-blogs/youtube-api-config.js');
        console.info('3. Replace the API_KEY with your actual key');
        console.info('4. 💡 Without API: System uses data from content.json');
        return false;
    }
